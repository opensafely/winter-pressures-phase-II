...
dataset.flu_sensitive = count_seasonal_flu_sensitive(study_start_date, study_end_date, app_reason_dict['ARI'], fever_codelist, resp_dict['flu_sensitive'], flu_med_codelist, flu_sensitive_exclusion)
