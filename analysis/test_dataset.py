...
test_data = {
    ...
    1: { 
        ...
        "opa_cost": [{"referral_request_received_date": date(2022, 1, 15)}, {"referral_request_received_date": date(2022, 1, 1)}],
        ...
        "appointments": [{"start_date": date(2022, 1, 8), "seen_date": date(2022, 1, 8), "status": "Cancelled by Unit"}, {"start_date": date(2022, 1, 15), "seen_date": date(2022, 1, 15), "status": "Waiting"}, {"start_date": date(2022, 1, 15), "seen_date": date(2022, 1, 15), "status": "Cancelled by Unit"}],
        # 1 flu vaccination, 1 covid vaccination, both in interval
        "vaccinations": [{"date": date(2022, 1, 15), "target_disease": "INFLUENZA"}, {"date": date(2022, 1, 15), "target_disease": "SARS-2 CORONAVIRUS"}],
