...
yaml_other = """
  ...
  # Generate national weekly aggregates for RSV_sensitive measure, for sense checking with other work packages.
  generate_national_weekly_rsv_sensitive:
    run: python:v2 analysis/national_weekly.py
    needs: [generate_practice_measures_resp_2016-04-11]
    outputs:
      moderately_sensitive:
        national_weekly_aggregates: output/practice_measures_resp/national_weekly_rsv_sensitive*.csv
"""
