...
for measure in measures:
    ...
    res_raw = stats.linregress(practice_interval_df.loc[mask, 'weeks_from_start'], practice_interval_df.loc[mask, 'rate_per_1000_midpoint6_derived'])
    results_dict[measure] = {
        ...
        "variance_raw": stats.variation(practice_interval_df.loc[mask, 'rate_per_1000_midpoint6_derived'])
    }
