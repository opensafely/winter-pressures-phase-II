...
input_path <- glue("output/{config$group}_measures_{config$set}{config$appt_suffix}{config$yearly_suffix}/proc_{config$group}_measures")
output_path <- glue("output/{config$group}_measures_{config$set}{config$appt_suffix}{config$yearly_suffix}/proc_{config$group}_measures_midpoint6")
